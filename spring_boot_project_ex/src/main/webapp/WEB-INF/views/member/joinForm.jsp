	          ...
	          <table>
	            ...
	            <tr>
	            	...
	            	<td colspan="3">
	            		...
	            		<input type="button" id="searchZipBtn" name="searchZipBtn" size="5" value="우편번호찾기"><br>
	            		<input type="text" id="address1" name="address1" size="70"><br>
	            		<input type="text" id="address2" name="address2" size="70" placeholder="상세 주소입력"><br>
	            	</td>
	            </tr>        
